...
import type { ModelsByProvider, ProviderInfo, PresetConfig, CouncilConfig } from '../types.js';
...
function generateProviderPreset(
  provider: string,
  modelsByProvider: ModelsByProvider,
  providers: ProviderInfo
): PresetConfig {
  const preset: PresetConfig = {};
  const providerOnly: ProviderInfo = {
    all: [provider],
    connected: [provider],
    priority: [provider],
  };
...
function generateLocalPreset(
  modelsByProvider: ModelsByProvider,
  localProviders: string[]
): PresetConfig {
  const preset: PresetConfig = {};
  const localOnly: ProviderInfo = {
    all: localProviders,
...
function generateCostOptimizedPreset(
  modelsByProvider: ModelsByProvider,
  providers: ProviderInfo
): PresetConfig {
  const preset: PresetConfig = {};
...
function getProviderPresetName(provider: string): string {
...
export function generateCouncilConfig(
  modelsByProvider: ModelsByProvider,
  providers: ProviderInfo
): CouncilConfig {
